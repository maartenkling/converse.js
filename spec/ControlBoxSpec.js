    ...
    describe("The Contacts Roster", $.proxy(function () {
        describe("Pending Contacts", $.proxy(function () {
            ...
            it("can be added to the roster", $.proxy(function () {
                ...
                this.roster.create({
                    jid: mock.pend_names[0].replace(' ','.').toLowerCase() + '@localhost',
                    subscription: 'none',
                    ask: 'subscribe',
            ...
            it("can be added to the roster and they will be sorted alphabetically", $.proxy(function () {
                ...
                for (i=0; i<mock.pend_names.length; i++) {
                    ...
                    this.roster.create({
                        jid: mock.pend_names[i].replace(' ','.').toLowerCase() + '@localhost',
                        subscription: 'none',
                        ask: 'subscribe',
        ...
        describe("Existing Contacts", $.proxy(function () {
            ...
            it("are ordered according to status: online, busy, away, unavailable, offline", $.proxy(function () {
                ...
                for (i=12; i<mock.cur_names.length; i++) {
        ...
        describe("Requesting Contacts", $.proxy(function () {
            ...
            it("can be added to the roster and they will be sorted alphabetically", $.proxy(function () {
                ...
                for (i=0; i<mock.req_names.length; i++) {
                    this.roster.create({
                        jid: mock.req_names[i].replace(' ','.').toLowerCase() + '@localhost',
                        subscription: 'none',
                        ask: 'request',
            ...
            it("can have their requests denied by the user", $.proxy(function () {
                var jid = mock.req_names.sort()[1].replace(' ','.').toLowerCase() + '@localhost';
                var view = this.rosterview.rosteritemviews[jid];
                spyOn(this.connection.roster, 'unauthorize');
